...
Alias: $EhmiDeliveryStatusTypesValueSet = http://medcomehmi.dk/ig/terminology/ValueSet/ehmi-delivery-status-types-valueSet
Alias: $EdsSubtypesVS = http://medcomehmi.dk/ig/terminology/CodeSystem/ehmi-delivery-status-sub-types
Alias: $EdsSubtypesVS = http://medcomehmi.dk/ig/terminology/ValueSet/ehmi-delivery-status-subtypes-valueSet
Alias: $EdsSubtypesVS2 = http://medcomehmi.dk/ig/terminology/ValueSet/ehmi-delivery-status-subtypes-valueSet2
