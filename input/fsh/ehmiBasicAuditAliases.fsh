...
Alias: $EHMIAuditEventAgentWhoIdentifiers = http://medcomehmi.dk/ig/ehmi_balp/CodeSystem/ehmi-auditevent-agent-who-identifier-types
...
Alias: $AuditEventSubTypes = http://hl7.org/fhir/R4/valueset-audit-event-sub-type.html
