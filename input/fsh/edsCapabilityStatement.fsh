...
* rest
  ...
  * resource[+]
    ...
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusCreate"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusRead"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusUpdate"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusDelete"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusQuery"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsPatientDeliveryStatusCreate"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsPatientDeliveryStatusRead"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsPatientDeliveryStatusUpdate"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsPatientDeliveryStatusDelete"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsPatientDeliveryStatusQuery"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinition/IHE.IUA.71"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusOAUTHaccessTokenUse.Comprehensive"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusOAUTHaccessTokenUse.Minimal"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusOAUTHaccessTokenUse.Opaque"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusSAMLaccessTokenUse.Comprehensive"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusSAMLaccessTokenUse.Minimal"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusAuthZconsent"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusPrivacyDisclosure.Recipient"
    * supportedProfile[+] = "http://medcomehmi.dk/ig/dk-medcom-ehmi-eds/StructureDefinitionEdsBasicDeliveryStatusPrivacyDisclosure.Source"
