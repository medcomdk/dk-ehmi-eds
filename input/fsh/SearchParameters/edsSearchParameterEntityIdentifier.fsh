...
* base = #AuditEvent
* type = #string
* expression = "AuditEvent.entity.where(type.code = 'ehmiMessage').what.identifier.value | AuditEvent.entity.where(type.code = 'ehmiMessageEnvelope').what.identifier.value | AuditEvent.entity.where(type.code = 'ehmiTransportEnvelope').what.identifier.value | AuditEvent.entity.where(type.code = '* insert ehmiOrigMessage-HCO
