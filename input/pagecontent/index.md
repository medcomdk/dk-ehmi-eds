...
For each scenario the "IG" column opens the example in a new window on a page in this IG, where the example is shown in ordinary IG-manner.

### 1. EDS scenarios for the primary MedCom message in EHMI

<table border="1" width="100%">
<tr><th width="5%">#</th><th width="83%">usecase</th><th width="12%">IG</th></tr>
<tr>
    <td>1.1</td>
