...
7. 
  - 7.1 When an ehmiSBDH envelope has been received in the receiving MSH (at 5.1 in the above use case) and the Receiving MSH creates an ehmiSBDH Acknowledgement<br/><a href="https://vhewer.com/display-product?url=https://hapifhir.ehmi.medcom.t0.hosting.kitkube.dk/fhir/AuditEvent/EDS-PDS-07.1" target="_blank">"Graphical view" example: EDS-PDS-07.1</a> ¤ <br/> <a href="https://hapifhir.ehmi.medcom.t0.hosting.kitkube.dk/fhir/AuditEvent/EDS-PDS-07.1" target="_blank">"Raw server view" example: EDS-PDS-07.1</a> ¤ <a href="AuditEvent-EDS-PDS-07.1.html">"Raw IG view" example: EDS-PDS-07.1</a>
