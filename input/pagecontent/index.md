...
1. When a message is created in an EUA (The user has hit the "sent button") or an ehmiSBDH_Ack has been initiated in a MSH. <br/><a href="https://vhewer.com/display-product?url=https://hapifhir.ehmi.medcom.t0.hosting.kitkube.dk/fhir/AuditEvent/EDS-PDS-01.1" target=""_blank"">Eksempel: EDS-PDS-01.1</a>
