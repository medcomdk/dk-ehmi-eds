...
- 6.1 When the message is actually received and finalized by the receiving EUA<br/><a href="https://vhewer.com/display-product?url=https://hapifhir.ehmi.medcom.t0.hosting.kitkube.dk/fhir/AuditEvent/EDS-PDS-06.2" target="_blank">"Graphical view" example: EDS-PDS-06.1</a> ¤ <br/> <a href="https://hapifhir.ehmi.medcom.t0.hosting.kitkube.dk/fhir/AuditEvent/EDS-PDS-06.2" target="_blank">"Raw server view" example: EDS-PDS-06.1</a> ¤ <a href="AuditEvent-EDS-PDS-06.2.html">"Raw IG view" example: EDS-PDS-06.1</a>
